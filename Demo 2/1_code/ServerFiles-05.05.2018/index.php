...
if(isset($_POST['submit'])){
	...
	if(!isset($error)){
		...
		try {
			...
			<p>To activate your account, please click on this link: <a href='http://100.8.176.108/activate.php?x=$id&y=$activasion'>http://100.8.176.108/activate.php?x=$id&y=$activasion</a></p>
            ...
            $mail->SetFrom('me.sender@gmail.com');
            $mail->AddReplyTo('no-reply@autohome.host','no-reply');
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">Welcome to AutoHome</span>
							<h1>Automate everything in your home from our website/app</h1>	
						</div>
									...
									<div class="tab-content">
										...
										<div class="tab-content-inner" data-content="login">
											<form role="form" method="post" action="" autocomplete="off">
												...
												<div class="row form-group">
													<div class="col-md-12">
														<input type="submit" name="submit2" value="Login" class="btn btn-primary btn-block btn-lg" tabindex="5">
													</div>
												</div>
											</form>	
										</div>
